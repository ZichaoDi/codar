...
% X=data(ind,1:2);
% %%========================================================
NN=10000;%[10 100 1000 5000 10000 15000 20000 ];%30000 40000 50000 60000 70000 80000 N_particle] ;
epsm=0.003;
...
for level=1:4
    ...
    if(strcmp(clustering,'dbscan'))
        ...
        if(level==1)
            ...
            N_cluster=min(sub2n,5);
                ind_k=sortind1(1:N_cluster);
                ind_k=setdiff(ind_k,ind_k_old);
...
ind_super=subind(sortind1(1:10));
t3(i)=toc;
% fprintf('time elapsed for clustering: %d\n',t2);
